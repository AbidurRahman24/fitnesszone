        ...
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
          ...
          <div className="md:w-1/2 px-8 md:px-16">
            ...
            <form onSubmit={handleUserSignIn} className="flex flex-col gap-4">
              <input className="p-2 mt-8 rounded-xl border" onBlur={handleEmailBlur} type="email" name="email" placeholder="Email" />
              <div className="relative">
                <input className="p-2 rounded-xl border w-full" onBlur={handlePasswordBlur} type="password" name="password" placeholder="Password" />
            ...
            <div className="mt-5 text-xs border-b border-[#002D74] py-4 text-[#002D74]">
              <p > Forgot your password? <button onClick={async () => {
